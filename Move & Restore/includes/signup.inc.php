...
//Check if one of the fields was left empty, and create error message and send user back to sign up page
...
//Checking to see if the username already exists in the database
    ...
    if(!mysqli_stmt_prepare($stmt, $sql)) {
        ...
        if ($resultCheck > 0) {
            header("Location: ../signup.php?error=sqlerror=usertaken&mail=".$email);
            exit();
        }
        else {
